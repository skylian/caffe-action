...
void BatchNormLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  if (this->phase_ == TRAIN) {
    caffe_gpu_axpby(batch_statistic_.count(), decay_,
                    batch_statistic_.gpu_data(), Dtype(1) - decay_,
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
			...
			batch_sum_multiplier_.gpu_data(),
                        batch_statistic_.gpu_data(),
                        Dtype(0), spatial_statistic_.mutable_gpu_data());
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
                        num_ * channels_, height_ * width_, 1,
                        Dtype(-1), spatial_statistic_.gpu_data(),
                        spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), buffer_blob_.mutable_gpu_data());
  // substract mean
  caffe_gpu_add(buffer_blob_.count(), const_bottom_data,
                buffer_blob_.gpu_data(), top_data);

  // ---------- variance normalization ---------- //
  // put the squares of X - mean into buffer_blob_
  caffe_gpu_powx(buffer_blob_.count(), const_top_data,
                 Dtype(2), buffer_blob_.mutable_gpu_data());
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, height_ * width_,
                        Dtype(1. / (height_ * width_)), buffer_blob_.gpu_data(),
			spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  caffe_gpu_gemv<Dtype>(CblasTrans, num_, channels_,
  ...
  // add eps
  caffe_gpu_add_scalar(batch_statistic_.count(), var_eps_,
                       batch_statistic_.mutable_gpu_data());
  // std
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
                        ...
                        Dtype(0), buffer_blob_.mutable_gpu_data());
  // variance normalization
  caffe_gpu_div(buffer_blob_.count(), const_top_data,
                buffer_blob_.gpu_data(), top_data);
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
                        ...
                        spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), buffer_blob_.mutable_gpu_data());
  caffe_gpu_mul(buffer_blob_.count(), const_top_data,
                buffer_blob_.gpu_data(), top_data);
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
                        ...
                        spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), buffer_blob_.mutable_gpu_data());
  caffe_gpu_add(buffer_blob_.count(), const_top_data,
                buffer_blob_.gpu_data(), top_data);
...
void BatchNormLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  caffe_gpu_mul(buffer_blob_.count(), x_norm_.gpu_data(),
                const_top_diff, buffer_blob_.mutable_gpu_data());
  // statistic across spatial
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_ * channels_, height_ * width_,
                        Dtype(1), buffer_blob_.gpu_data(),
			spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), spatial_statistic_.mutable_gpu_data());
  // statistic across batch
  caffe_gpu_gemv<Dtype>(CblasTrans, num_, channels_,
  ...
  caffe_gpu_gemm<Dtype>(CblasNoTrans, CblasNoTrans,
                        ...
                        spatial_sum_multiplier_.gpu_data(),
                        Dtype(0), buffer_blob_.mutable_gpu_data());
  caffe_gpu_mul(buffer_blob_.count(), const_top_diff,
