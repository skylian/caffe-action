...
protected:
	...
	bool global_pooling_, global_pooling_height_, global_pooling_width_;
 ...
 *       top[0]    dim: NxCxHxW where each channel is the spatial product between
